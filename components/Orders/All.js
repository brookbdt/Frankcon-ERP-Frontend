      ...
      <Table sx={{ minWidth: 650 }} aria-label="simple table">
        ...
        <TableBody>
          {response?.data?.map((response, index) => (
            <TableRow key={response.attributes?.itemName}>
              <TableCell>
              ...
              <TableCell>
                <Stack>
                  <Typography> {response.attributes?.vendorAddress}</Typography>
                  <Typography
                    sx={{
                      fontWeight: "400",
                      fontSize: "12px",
              ...
              <TableCell>
                <Typography>{response.attributes?.requestDate}</Typography>
              </TableCell>
              <TableCell>
                <Typography>{response.attributes?.isApproved}</Typography>
              </TableCell>
              <TableCell>
                    ...
                    <Box display="flex" alignItems="center">
                      ...
                      <IconButton
                        ...
                        sx={{
                          ...
                          borderRadius: "50%",
                          backgroundColor:
                            response.attributes?.isApproved === "in purchase"
                              ? "#24B07D"
                              : "#E7E7EA",
                        }}
                      >
                      ...
                      <IconButton
                        ...
                        sx={{
                          ...
                          borderRadius: "50%",
                          backgroundColor:
                            response.attributes?.isApproved === "on delivery"
                              ? "#FFBA2E"
                              : "#E7E7EA",
                        }}
                      >
