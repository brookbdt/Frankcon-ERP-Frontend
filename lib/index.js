...
export const readTask = (jwt, id) =>
  axios.get(`${url}/tasks?filters[employee][id][$eq]=${id}&pagination[limit]=1000`, {
    headers: {
      Authorization: "Bearer " + jwt,
    },
  });
...
export const readEmployee = (jwt) =>
  axios.get(`${url}/employees?populate=%2A&pagination[limit]=1000`, {
    headers: {
      Authorization: "Bearer " + jwt,
    },
  });
export const readPayroll = (jwt) =>
  axios.get(`${url}/payrolls?populate=%2A&pagination[limit]=1000`, {
    headers: {
      Authorization: "Bearer " + jwt,
    },
  });
...
export const readPaymentsRequests = (jwt, user) =>
  axios.get(`${url}/paymentrequests?populate=%2a&pagination[limit]=1000`, {
    headers: {
      Authorization: "Bearer " + jwt,
    },
  });
export const readEmployeeUnresolvedTask = (jwt, user) =>
  axios.get(
    `${url}/tasks?filters[employee][users_permissions_user][username]=${user}&filters[status][$ne]=DONE&pagination[limit]=1000`,
    {
      headers: {
        Authorization: "Bearer " + jwt,
      },
...
export const readProjectResolvedTask = (id, jwt, user) =>
  axios.get(
    `${url}/tasks/?filters[projects]=${id}&filters[status]=DONE&populate[0]=employee&populate[1]=employee_checkeds&populate[2]=employee_checkeds.employeeImage&populate[3]=employee.employeeImage&populate[4]=comments&populate[5]=taskFiles&pagination[limit]=1000`,
    {
      headers: {
        Authorization: "Bearer " + jwt,
      },
...
export const readProjectInprogressTask = (id, jwt, user) =>
  axios.get(
    `${url}/tasks/?filters[projects]=${id}&filters[status]=INPROGRESS&populate[0]=employee&populate[1]=employee_checkeds&populate[2]=employee_checkeds.employeeImage&populate[3]=employee.employeeImage&populate[4]=comments&populate[5]=taskFiles&pagination[limit]=1000`,
    {
      headers: {
        Authorization: "Bearer " + jwt,
      },
...
export const readProjectBacklogTask = (id, jwt, user) =>
  axios.get(
    `${url}/tasks/?filters[projects]=${id}&filters[status]=INREVIEW&populate[0]=employee&populate[1]=employee_checkeds&populate[2]=employee_checkeds.employeeImage&populate[3]=employee.employeeImage&populate[4]=comments&populate[5]=taskFiles&pagination[limit]=1000`,
    {
      headers: {
        Authorization: "Bearer " + jwt,
      },
...
export const readProjectTodoTask = (id, jwt, user) =>
  axios.get(
    `${url}/tasks/?filters[projects]=${id}&filters[status]=TO%20DO&populate[0]=employee&populate[1]=employee_checkeds&populate[2]=employee_checkeds.employeeImage&populate[3]=employee.employeeImage&populate[4]=comments&populate[5]=taskFiles&pagination[limit]=1000`,
    {
      headers: {
        Authorization: "Bearer " + jwt,
      },
...
export const readEmployeeInprogressTask = async (jwt, user) =>
  axios.get(
    `${url}/tasks?filters[employee][users_permissions_user][username]=${user}&filters[status][$eq]=INPROGRESS&pagination[limit]=1000`,
    {
      headers: {
        Authorization: "Bearer " + jwt,
      },
...
export const readDepletingItems = async (jwt, user) =>
  axios.get(
    `${url}/tag-registrations?filters[employee][users_permissions_user][username]=${user}&filters[status][$eq]=INPROGRESS&pagination[limit]=1000`,
    {
      headers: {
        Authorization: "Bearer " + jwt,
      },
...
export const readEmployeeByDepartment = (jwt, department) =>
  axios.get(
    `${url}/employees?populate=%2a&filters[department][$eq]=${department}&pagination[limit]=1000`,
    {
      headers: {
        Authorization: "Bearer " + jwt,
      },
...
export const readEmployeeTodoTask = (jwt, user) =>
  axios.get(
    `${url}/tasks?filters[employee][users_permissions_user][username]=${user}&filters[status][$eq]=TO+DO&pagination[limit]=1000`,
    {
      headers: {
        Authorization: "Bearer " + jwt,
      },
...
export const readEmployeeDepartmentTask = (jwt, department) =>
  axios.get(`${url}/tasks?filters[department][$eq]=${department}&pagination[limit]=1000`, {
    headers: {
      Authorization: "Bearer " + jwt,
    },
  });
export const readEmployeeDetail = (jwt, user) =>
  axios.get(
    `${url}/employees?filters[users_permissions_user][username][$eq]=${user}&populate=%2a&pagination[limit]=1000`,
    {
      headers: {
        Authorization: "Bearer " + jwt,
      },
...
export const readOrder = (jwt) =>
  axios.get(`${url}/orders&pagination[limit]=1000`, {
    headers: {
      Authorization: "Bearer " + jwt,
    },
  });
...
export const readInventory = (jwt) =>
  axios.get(`${url}/tag-registrations?populate=%2a&pagination[limit]=1000`, {
    headers: {
      Authorization: "Bearer " + jwt,
    },
  });
...
export const readMaterialTransferRequest = (id, jwt) =>
  axios.get(`${url}/materialtransferrequests/${id}?populate=%2a&pagination[limit]=1000`, {
    headers: {
      Authorization: "Bearer " + jwt,
    },
  });
export const readAllMaterialTransferRequest = (jwt) =>
  axios.get(`${url}/materialtransferrequests?populate=%2a&pagination[limit]=1000`, {
    headers: {
      Authorization: "Bearer " + jwt,
    },
  });
export const readInventoryDocs = (jwt) =>
  axios.get(`${url}/inventory-documentations?populate=%2a&pagination[limit]=1000`, {
    headers: {
      Authorization: "Bearer " + jwt,
    },
  });
export const readWorkshopTasks = (jwt) =>
  axios.get(`${url}/Workshop-Tasks?populate=%2a&pagination[limit]=1000`, {
    headers: {
      Authorization: "Bearer " + jwt,
    },
  });
...
export const readPurchaseRequest = (jwt) =>
  axios.get(`${url}/purchaserequests?populate=*&pagination[limit]=1000`, {
    headers: {
      Authorization: "Bearer " + jwt,
    },
  });
export const readVendor = (jwt) =>
  axios.get(`${url}/vendors?populate=*&pagination[limit]=1000`, {
    headers: {
      Authorization: "Bearer " + jwt,
    },
  });
export const readInboundReceivingForm = (jwt) =>
  axios.get(`${url}/inbound-receiving-forms?populate=*&pagination[limit]=1000`, {
    headers: {
      Authorization: "Bearer " + jwt,
    },
  });
...
export const editProject = async (editedProject, id, jwt) =>
  await axios.put(`${url}/projects/${id}`, editedProject, {
    headers: {
      Authorization: "Bearer " + jwt,
    },
  });
...
// await axios.get(`${url}/monthly-expenses?sort=id%3adesc&pagination[limit]=1&populate=%2a`, {
// ?filters[$and][0][createdAt][$gte]=2023-04-01T10:45:22.347Z&filters[$and][1][publishedAt][$lt]=2023-04-06T10:45:22.347Z

export const readMonthlyExpense = async (jwt, startDate, endDate) =>
  await axios.get(`${url}/monthly-expenses?filters[$and][0][createdAt][$gte]=${startDate}&filters[$and][1][publishedAt][$lt]=${endDate}&pagination[limit]=1000`, {
    headers: {
      Authorization: "Bearer " + jwt,
    },
  });
export const createMonthlyExpense = async (newExpense, jwt) =>
  await axios.post(`${url}/monthly-expenses`, newExpense, {
    headers: {
      Authorization: "Bearer " + jwt,
    },
  });

// export const readMonthlyExpense = async (jwt) =>
//   await axios.get(`${url}/monthly-expenses?sort=id%3adesc&pagination[limit]=1&populate=%2a`, {
//     headers: {
//       Authorization: "Bearer " + jwt,
//     },
...
export const getPaymentRequest = async (paymentRequest, id, jwt) =>
  await axios.get(`${url}/paymentRequests/${id}&pagination[limit]=1000`, paymentRequest, {
    headers: {
      Authorization: "Bearer " + jwt,
    },
  });
...
export const getInventoryQuantity = async (id, jwt) =>
  await axios.get(`${url}/tag-registrations/${id}&pagination[limit]=1000`, {
    headers: {
      Authorization: "Bearer " + jwt,
    },
  });
...
export const readProjectDetail = async (id, jwt, user) =>
  await axios.get(
    `${url}/projects/${id}?filters[employees][users_permissions_user][username]=${user}&populate=*&pagination[limit]=1000`,
    {
      headers: {
        Authorization: "Bearer " + jwt,
      },
...
export const readProject = (jwt, user) =>
  axios.get(
    `${url}/projects?filters[employees][users_permissions_user][username]=${user}&populate=*&pagination[limit]=1000`,
    {
      headers: {
        Authorization: "Bearer " + jwt,
      },
...
export const readAllProjects = (jwt, user) =>
  axios.get(`${url}/projects?populate=%2a&pagination[limit]=1000`, {
    headers: {
      Authorization: "Bearer " + jwt,
    },
  });
...
export const readNotification = async (jwt, user) =>
  await axios.get(`${url}/notifications?filters[$or][0][employees][users_permissions_user][username][$eq]=${user}&filters[$or][1][employee][users_permissions_user][username][$eq]=${user}&filters[$or][2][admin_notify][users_permissions_user][username][$eq]=${user}&filters[$or][3][purchaser_notify][users_permissions_user][username][$eq]=${user}&filters[$or][4][finance_notify][users_permissions_user][username][$eq]=${user}&populate=%2a&pagination[limit]=1000`, {
    headers: {
      Authorization: "Bearer " + jwt,
    },
  });
export const readPaymentNotification = async (jwt, user) =>
  await axios.get(`${url}/payment-request-notifications?filters[$or][0][employees][users_permissions_user][username][$eq]=${user}&filters[$or][1][employee][users_permissions_user][username][$eq]=${user}&populate=%2a&pagination[limit]=1000`, {
    headers: {
      Authorization: "Bearer " + jwt,
    },
  });

  // http://localhost:1337/api/monthly-expenses?filters[$and][0][createdAt][$gte]=2023-04-01T10:45:22.347Z&filters[$and][1][publishedAt][$lt]=2023-04-06T10:45:22.347Z
