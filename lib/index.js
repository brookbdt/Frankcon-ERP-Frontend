...
export const readProjectResolvedTask = (id, jwt, user) =>
  axios.get(
    `${url}/projects/${id}?filters[employees][users_permissions_user][username]=${user}&filters[tasks][status][$eq]=DONE&populate[0]=comments.employee&populate[1]=projectImage&populate[2]=tasks&populate[3]=tasks.employee_checkeds&populate[4]=tasks.employee_checkeds.employeeImage`,
    {
      headers: {
        Authorization: "Bearer " + jwt,
      },
